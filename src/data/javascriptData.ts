...
export const jsProjects = [
  ...
  },
  {
    ...
    title: 'Page Builder',
    description:
      'An interface for quickly mocking up simple webpages in realtime.',
  ...
  },
  {
    ...
    title: 'World Clocks',
    description:
      'A simple display of multiple timezones from around the world, including their weather.',
  ...
  },
  {
    ...
    title: 'User Login',
    description:
      'A user account system with registration, login, admin access and management.',
  ...
  },
  {
    ...
    title: 'Memory Game',
    description:
      'A grid pattern matching memory game with adjustable difficulty.',
